...
import { BookOpen, ChevronLeft, ChevronRight, ExternalLink, Info, ListChecks, MessagesSquare, Search } from 'lucide-react'
import {
  getMyStudyStatus,
  listCards,
  listDecks,
...
type View = 'menu' | 'intro' | 'flash' | 'qna' | 'search' | 'cbt'
